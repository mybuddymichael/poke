...
2. If you have Bundler installed, `cd` into `Poke/` and simply type `bundle install` to install gem dependencies. Otherwise you have to `gem install gosu` and  `gem install rmagick`.
